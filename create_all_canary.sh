...
kubectl apply -f virtualnodes_canary.yaml

kubectl apply -f virtualservices_canary.yaml 


kubectl apply  -f services.yaml 

kubectl apply  -f ../code2statebckv1/services_canary.yaml

kubectl apply  -f api-test-front.yaml

kubectl apply  -f ../code2statebck/api-test-back.yaml

kubectl apply  -f ../code2statebckv1/api-test-back.yaml
